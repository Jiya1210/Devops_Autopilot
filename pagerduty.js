 ...
 */
async function fetchPagerDutyIncident(incidentId) {
...
const fetchAlertHandler = async ({ incident_id }) => {
    try {
        ...
        const incidentData = {
            ...
            body: incident.body,
            assignments: incident.assignments?.map((a) => ({
                assignee: {
...
index_1.server.tool('fetch_alert', {
    incident_id: zod_1.z.string().describe('PagerDuty incident ID (e.g., P123456 or PXXXXXX)')
}, fetchAlertHandler);
