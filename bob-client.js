...
class BobClient {
    ...
    mockMode;
    timeout;
    constructor(apiKey, baseUrl = 'https://api.ibm-bob.com', mockMode = false, timeout = 300000 // 5 minutes default
    ) {
        this.apiKey = apiKey;
    ...
    async runAgent(request) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.baseUrl}/v1/agent/run`, {
...
exports.BobClient = BobClient;
// Made with Bob
//# sourceMappingURL=bob-client.js.map